 ...
 let iconFav;
  ...
  return (
    <> {
      ...
      user ? 
      iconFav? 
  <div className='mt-3 text-3xl 2xl:text-3xl mx-2 text-red-500 lg:p-2' > 
     <BsHeartFill className='cursor-pointer' onClick={unFav}/>
     </div>
     :
      <div className='mt-3 text-3xl mx-2 2xl:text-3xl text-red-500 lg:p-2'> 
      <AiOutlineHeart className='cursor-pointer ' onClick={onFav}/>
      </div>

      :
 <div className='my-2 text-3xl mx-2 2xl:text-3xl text-red-500 lg:p-2'> 
      <AiOutlineHeart className='cursor-pointer ' onClick={onFav}/>
      </div>
